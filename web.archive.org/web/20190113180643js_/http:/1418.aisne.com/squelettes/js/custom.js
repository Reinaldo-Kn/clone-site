    ...
    $(document).ready(function(){
        ...
        $('#formulaire_bleuetsphotos form').on('submit', function() {
            ...
            if(!$('#bleuets_prenom').val()){
                check = false;
                checkText += "Merci de saisir votre prénom.\n";
            }
            if($('#bleuets_mail').val() == "" || !isEmail($('#bleuets_mail').val())){
                check = false;
                checkText += "Merci de vérfier votre email.\n";
            }
            ...
            if(photo1 != "" && $('#bleuets_photo1_titre').val() == ""){
                check = false;
                checkText += "Photo #1 : merci de donner un titre à votre photo.\n";
            }
            ...
            if(photo2 != "" && $('#bleuets_photo2_titre').val() == ""){
                check = false;
                checkText += "Photo #2 : merci de donner un titre à votre photo.\n";
            }
            ...
            if(photo3 != "" && $('#bleuets_photo3_titre').val() == ""){
                check = false;
                checkText += "Photo #3 : merci de donner un titre à votre photo.\n";
            }
            ...
            if(photo4 != "" && $('#bleuets_photo4_titre').val() == ""){
                check = false;
                checkText += "Photo #4 : merci de donner un titre à votre photo.\n";
            }
            ...
            if(photo5 != "" && $('#bleuets_photo5_titre').val() == ""){
                check = false;
                checkText += "Photo #5 : merci de donner un titre à votre photo.\n";
            }
